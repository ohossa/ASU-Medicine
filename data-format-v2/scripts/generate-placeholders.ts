...
const MODULES: ModuleInfo[] = [
  ...
  { code: 'IPHA-1', name: 'Introduction to Clinical Pharmacology', year: 1, semester: 2, creditPoints: 3, totalMarks: 60, keywords: ['pharmacology', 'ipha'], chapters: [{ id: 1, title: 'Pharmacokinetics', emoji: '💊', lectureRange: 'Lectures 1-4' }, { id: 2, title: 'Pharmacodynamics', emoji: '🧬', lectureRange: 'Lectures 5-9' }, { id: 3, title: 'Adrenergic System', emoji: '⚡', lectureRange: 'Lectures 10-11' }, { id: 4, title: 'Cholinergic System', emoji: '🧠', lectureRange: 'Lectures 12-13' }, { id: 5, title: 'Calculations', emoji: '🧮', lectureRange: 'Lecture 14' }] },
